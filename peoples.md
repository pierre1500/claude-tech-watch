...
| Yuval Ronen | Security Researcher | Palo Alto Networks (Unit 42) | Agentic endpoint security, developer supply chain security | Co-authored analysis of TeamPCP's poisoned Nx Console VS Code extension attack against GitHub; introduced "Agentic Endpoint Security" (AES) as distinct security category from traditional EDR for developer/agent endpoints | Published Palo Alto blog on Koi protection vs. developer supply chain attacks (May 22, 2026); documented 18-36 minute VS Code extension attack exfiltrating 3,800 GitHub internal repos | 2026-05-23 |
| Emran Mazumder | Security Researcher | Palo Alto Networks (Unit 42) | Supply chain security, developer endpoint protection | Co-authored Koi AES analysis documenting VS Code Marketplace as tier-1 supply chain attack surface; contributed to Agentic Endpoint Security framing as protection model for agentic developer endpoints with full cloud credential access | Co-published TeamPCP/Nx Console attack analysis (May 22, 2026); contributed to Agentic Endpoint Security product framing | 2026-05-23 |
...
| Jeffrey Ying | Software Engineer | Google | Kubernetes API server scalability, large-cluster optimization, etcd internals | Authored KEP-5866 (server-side sharded list and watch for Kubernetes v1.36) and contributed RangeStream to etcd 3.7.0 — solving the bandwidth-multiplication scaling paradox at both API server and database layers | Published Kubernetes v1.36 alpha feature blog post (May 6, 2026); named in etcd 3.7.0-beta.0 blog as contributor who delivered RangeStream (May 20, 2026); cross-project contributor addressing the same scaling bottleneck at two layers | 2026-05-19 |
...
| Saeed Abbasi | Senior Manager, Threat Research Unit | Qualys | Linux kernel security, vulnerability research, coordinated disclosure | Led discovery and full advisory publication of CVE-2026-46333 (Linux ptrace privilege escalation present since November 2016); developed four working exploits targeting gpg-keysign, pkexec, and accounts-daemon; navigated responsible disclosure under broken embargo conditions | Published complete CVE-2026-46333 advisory (May 20, 2026); coordinated responsible disclosure with upstream Linux kernel team; released full advisory after independent exploit derived from public kernel commit ended embargo protection | 2026-05-23 |
...
| Jason Robert | Engineering / Open Source | Microsoft | Deterministic multi-agent orchestration, agentic workflow design | Designed and published Microsoft Conductor — YAML-first deterministic multi-agent orchestration CLI eliminating token-consuming LLM routing; positions declarative workflow topology as the correct primitive for production multi-agent systems with predictable cost models | Published Conductor launch blog (May 14, 2026); authored the "declarable, diffable, as readable as CI/CD pipeline" framing for agent workflows; zero-token routing layer is the key architectural innovation | 2026-05-23 |
| David Soria Parra | Lead Maintainer | Model Context Protocol (Anthropic) | MCP protocol design, stateless distributed systems, developer experience | Co-led the largest MCP revision since launch — 2026-07-28 RC delivering stateless core, MCP Apps, Tasks extension, and 12-month deprecation lifecycle; the governance architecture enabling enterprise commitment to MCP as long-term platform | Co-published MCP 2026-07-28 RC (May 21, 2026); co-authored six SEPs completing the stateless MCP roadmap; established the SDK Tier compliance framework | 2026-05-23 |
| Den Delimarsky | Lead Maintainer | Model Context Protocol (Anthropic) | MCP protocol design, developer tooling, specification governance | Co-lead maintainer on MCP 2026-07-28 RC; contributor to Mcp-Method/Mcp-Name headers enabling gateway-level routing and the Extensions framework for opt-in capability evolution | Co-published MCP 2026-07-28 RC (May 21, 2026); key contributor to the 12-month feature lifecycle policy enabling enterprise roadmap commitment | 2026-05-23 |
