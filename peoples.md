...
| Cathy Polinsky | Co-CTO & VP Engineering | Semgrep | AI code security at scale, engineering organization scaling | Joined to scale Semgrep's engineering through the AI-generated code era; one of four companies in OpenAI's Trusted Access for Cyber program; leads hybrid LLM + deterministic static analysis product strategy running 100M+ scans/year for Okta, Dropbox, Lyft, Figma | Appointed Co-CTO & VP Engineering at Semgrep (May 6, 2026); prior CTO roles at Stitch Fix and Shopify; background in Salesforce, Yahoo!, DataGrail; scaling the engineering org through the AI coding transformation | 2026-05-25 |
...
| Joe Chen | Chief Technology Officer | Trellix | AI-era endpoint security, ML-driven threat detection, engineering transformation at scale | Appointed CTO to lead Trellix's cybersecurity strategy and R&D for the AI era; background in ML-driven threat detection, network security, endpoint protection at Broadcom/Symantec and Carbon Black; operating partner at Crosspoint Capital focused on engineering transformation | Appointed CTO at Trellix (May 20, 2026); working with CPO Alex Au Yeung on AI-era security technologies; prior VP Engineering at Broadcom, Symantec, Carbon Black leading global ML security teams | 2026-05-25 |
| Amine Raji | Cloud Cybersecurity Leader | Volvo Cars | Cloud-native AI attack surfaces, MCP deployment security, OWASP Agentic Security | PhD/CISSP, OWASP Agentic Security project contributor; empirically demonstrates that CloudTrail events, resource tags, monitoring alerts, and pipeline output flowing into AI agent context windows bypass all model-layer defenses; the most technically rigorous public voice on cloud-native AI attack surfaces and agent infrastructure security | Active keynote speaker and newsletter author (AI Security Intelligence, May 2026); contributor to OWASP Agentic Security Initiative; speakers on "Your Cloud Infrastructure Is a Prompt Injection Surface" and MCP attack patterns (tool poisoning, meta-context injection, cross-server hijacking) | 2026-05-25 |
...
| Matt Wood | Chief AI & Technology Officer | AWS | AWS AI product strategy, enterprise AI production adoption | Returning to AWS (after 14+ year prior tenure building SageMaker, Bedrock, Amazon Q) in a newly created Chief AI and Technology Officer role; bridges deep AWS technical knowledge with enterprise-grade AI-to-production expertise from PwC consulting tenure | Announced as AWS Chief AI & Technology Officer (May 18, 2026); reports to AWS CMO Julia White; focus on moving enterprise customers from AI experimentation to production; Amazon spending ~$200B capex in 2026 mostly on AI infrastructure | 2026-05-25 |
...
| David Soria Parra | Lead Maintainer, MCP | Anthropic | MCP protocol design, agent infrastructure standards, stateless agent execution | Co-lead on the MCP 2026-07-28 Release Candidate — the largest protocol revision since launch; architect of the stateless HTTP model (6 SEPs), MCP Apps (server-rendered sandboxed UIs), Tasks extension (async tool handles), and 12-month feature lifecycle policy; defines the protocol evolution path for the entire MCP ecosystem | Published MCP 2026-07-28 RC blog post (May 21, 2026) co-authored with Den Delimarsky; led the stateless HTTP redesign that eliminates sticky sessions for remote MCP servers; maintains conformance suite and SDK tier system | 2026-05-25 |
