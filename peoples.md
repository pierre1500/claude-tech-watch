...
| Yonggan Fu | Research Scientist | NVIDIA | Diffusion language models, LLM inference architecture, efficient decoding | Lead author of Nemotron-Labs Diffusion — first production-scale tri-mode DLM family (AR/diffusion/self-speculation from one checkpoint) achieving 6.4× throughput; 24K+ HuggingFace downloads in 24h; defining the post-autoregressive inference paradigm | Published Nemotron-Labs Diffusion technical report + released 7 model checkpoints on HuggingFace (May 23, 2026); SGLang integration submitted (PR #25803) | 2026-05-24 |
...
| Raluca Ada Popa | Head of Security & Privacy Research + Gemini Security Lead | Google DeepMind / UC Berkeley | AI security research, confidential computing for AI, automated vulnerability remediation at scale | Leading Google DeepMind's CodeMender (72 OSS security patches via AI agent) and building Security & Privacy Research team; co-founder of Opaque Systems (confidential AI computing); first to quantify AI-driven security patch velocity at OSS scale | Promoted CodeMender initiative (AI agent auto-patching critical OSS vulnerabilities) and announced 20+ security research openings at Google DeepMind; active on LinkedIn May 2026 | 2026-05-24 |
...
| Raza Sharif | Security Researcher / IETF Author | Independent / AEBA | MCP security standards, agent identity, cryptographic trust hierarchies for agentic systems | Author of IETF draft-sharif-attp (Agent Trust Transport Protocol) and draft-sharif-mcps-secure-mcp; first to publish IETF-track specifications for MCP security aligned with the NSA's playbook; defining the cryptographic governance layer above MCP with 5-level trust hierarchy (L0-L4) | Published ATTP IETF draft (live May 1, 2026); published NSA MCP Security Playbook integration guide on DEV Community (May 23, 2026); CVE-2026-39313 cited; Kong API Gateway plugin in development | 2026-05-24 |
