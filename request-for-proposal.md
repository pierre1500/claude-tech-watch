...
| Choose France 2026 AI Infrastructure Technical Services Framework — Hauts-de-France Data Center Program | SoftBank Group / French Republic (Choose France 2026) | €45B first phase (total program €75B) — technical services subcontracts TBD | Engineering, operations, and technical integration partners for SoftBank's 3.1 GW Hauts-de-France AI data center program — sites at Dunkirk (Loon-Plage), Le Bosquel, and Bouchain; manufacturing cluster at Port of Dunkirk for enclosures and power modules (Schneider Electric selected as primary); EDF nuclear site conversion at Bouchain; data center operations, cooling, electrical integration, and network fabric deployment; AI infrastructure for cloud providers, enterprises, research organizations | Ongoing 2026–2031 (first phase) | Open: Schneider Electric named manufacturing cluster partner; EDF named Bouchain site partner; Sesterce JV named Le Bosquel operator; technical subcontracting and supplier RFPs expected H2 2026 through French public procurement (DNUM/DINUM channels); SoftBank Group press release May 31, 2026 | 2026-05-31 |
