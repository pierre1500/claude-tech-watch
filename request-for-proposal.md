...
| AI/ML Cybersecurity of Novel Technology Implementations (ITES-10204) | US Nuclear Regulatory Commission (NRC), Rockville, Maryland | Undisclosed (Small Business Set-Aside) | Research and technical basis for cybersecurity concerns of AI/ML technologies in operating and new/advanced nuclear reactors — in-depth literature assessment, evaluation of AI/ML application in nuclear power plants (NPPs) covering both current operating and advanced reactor designs; assessment must address cybersecurity risks specific to AI/ML control systems in nuclear environments | May 26, 2026 | Open competitive RFP (ITES-10204) — Small Business Set-Aside; US organizations only; posted May 6, 2026 | 2026-05-23 |
...
| DHS NOSC NCCS 2.0 Network Cyber & Cloud Support (F2026073416) | Department of Homeland Security (DHS), Office of CIO, NOSC | $100M ceiling (IDIQ, 1-year base + 4x1-year options) | Full-range cybersecurity and network operations support for DHS HQ OCIO and select Components — SOC/NOC monitoring and analysis, cloud platform cybersecurity, threat hunting, CFMA (cyber forensics and malware analysis), penetration testing, insider threat, FISMA metrics; goal is to evolve DHS NOSC to Center of Excellence maturity under ITIL v4 + NIST CSF | May 29, 2026 | Pre-RFP (F2026073416) — solicitation expected May 29, 2026; award estimate July 2026; IDIQ NAICS 541519 | 2026-05-23 |
| Managed Security Services Provider (MSSP) for MD State Board of Elections (BPM056889) | Maryland State Board of Elections (SBE) | $2.5M–$9M est. (2-year base + 2x2-year options) | Comprehensive MSSP for election board: secure configuration/compliance (NIST 800-53 Rev. 5 + CIS), application security, zero trust architecture, SOC with SIEM, technology risk management, security advisory; Small Business Reserve procurement with 10% MBE subcontracting goal; primary place of performance Annapolis MD or remote | July 8, 2026 | Open competitive RFP (BPM056889) — double envelope proposal; pre-bid conference May 14, 2026; questions due May 18, 2026 | 2026-05-23 |
